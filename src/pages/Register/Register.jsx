...
function Register() {
  ...
  return (
    <>
      <div className="flex items-center justify-center min-h-screen bg-gradient-to-b from-[#d3c0f9] to-[#f0b3e1]">
        <div className="w-full max-w-[380px] bg-white p-4 rounded-xl shadow-lg sm:w-[320px]">
          <h1 className="text-center text-[#5f0361] font-bold text-3xl sm:text-4xl">
            Register
          </h1>
          <form onSubmit={handleSubmit} className="flex flex-col mt-4">
            {inputs.map((input) => (
            ...
            <p style={{ color: "#4A90E2" }}>
              Sizda akkauntga egamisiz?
              <Link to="/login" style={{ color: "#E94E77" }}>
                Tizimga kiring
              </Link>
            </p>
            <button
